        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3">
          <div>
            <h3 className="text-lg font-bold text-white flex items-center gap-2">
              <Terminal className="w-5 h-5 text-primary" /> Application System
              Logs
            </h3>
            ...
            filteredLogs
              ...
              .map((log, index) => {
                ...
                switch (log.level) {
                  ...
                  case "failure":
                    levelColor =
                      "text-purple-400 bg-purple-950/20 border border-purple-900/40";
                    Icon = ShieldAlert;
                    break;
                }
                return (
                  <div
                    key={index}
                    className="p-3 hover:bg-base-100/10 flex flex-col sm:flex-row sm:items-start gap-2.5 transition-colors duration-150"
                  >
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                      ...
                      <span
                        className={`px-2 py-0.5 rounded text-[10px] uppercase font-bold flex items-center gap-1 leading-none ${levelColor}`}
                      >
                    ...
                    <div className="flex-grow min-w-0">
                      <p className="text-slate-300 break-words leading-normal font-sans">
                        {log.message}
                      </p>
                      {log.context && (
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-xl bg-base-100/30 border border-slate-900">
            ...
            <span className="text-slate-400 text-xs">
              Bundles assets and builds the Electrobun binary for canary
              release.
            </span>
          </div>
        </div>
