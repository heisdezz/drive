...
import {
  CreateAlbumModal,
  type ModalHandle,
} from "@/components/CreateAlbumModal";
...
function AlbumsIndexComponent() {
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      {/* Filter & Sort Bar */}
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-base-300/50 border border-base-200 p-4 rounded-xl sticky top-0 z-10 bg-base-200/80 backdrop-blur-xs">
        ...
        <div className="space-y-3 text-left">
          ...
          <div className="alert alert-info text-xs p-3 rounded-xl flex gap-2 items-start leading-relaxed bg-info/10 border-info/20 text-base-content">
            ...
            <div>
              ...
              <span className="font-bold text-primary">not</span> be deleted.
              They will be safely relocated back to the{" "}
              <span className="font-bold">Unsorted Media (unknown)</span>{" "}
              section.
            </div>
          </div>
        </div>
