...
function DiscoverComponent() {
    ...
    return (
      <div className="space-y-6 max-w-5xl">
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-slate-900/60 to-slate-950/40 border border-slate-900 shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="px-3.5 py-1.5 rounded-lg bg-base-100/80 border border-slate-800 font-mono text-xs text-slate-400 select-all">
            {selectedDrive.path}
          </div>
        </div>

        {/* Discover CTA Card */}
        <div className="p-8 sm:p-12 rounded-3xl bg-base-100/30 border border-slate-900 flex flex-col items-center text-center space-y-6 shadow-2xl relative overflow-hidden">
          ...
          <div className="w-full max-w-md p-4 rounded-xl bg-slate-950/60 border border-slate-900 space-y-4 text-left">
            <div className="form-control w-full">
              <label className="label py-1">
                <span className="label-text text-[10px] text-slate-500 font-bold uppercase">
              ...
              <input
                ...
                className="input input-bordered input-sm w-full bg-base-100 border-slate-800 text-xs focus:border-primary text-white"
              />
            </div>
          </div>
  ...
  return (
    <div className="space-y-8 max-w-5xl">
      ...
      {scaffolding ? (
        <div className="p-6 rounded-2xl bg-base-100/20 border border-slate-900/80 flex items-center gap-4">
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 p-6 rounded-2xl bg-base-100/40 border border-slate-900/80 space-y-4">
            ...
            <div className="p-6 rounded-2xl bg-base-100/40 border border-slate-900/80 flex flex-col justify-between gap-4">
              <div>
                ...
                <div className="mt-4 space-y-3">
                  <div className="flex justify-between text-xs border-b border-slate-900 pb-2">
                    ...
                    <span
                      className={`font-bold uppercase ${scanStatus?.scanning ? "text-primary animate-pulse" : "text-slate-400"}`}
                    >
              ...
              {scanStatus?.scanning && (
                <div className="w-full space-y-3">
                  <div className="w-full space-y-1">
                    ...
                    <span className="text-[8px] text-slate-600 block text-right font-mono truncate">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <h3 className="text-sm font-black tracking-wider text-slate-400 uppercase flex items-center gap-1.5">
                  <Database className="w-4 h-4 text-emerald-400" /> Cataloged
                  Media Library
                </h3>
                <span className="badge badge-sm badge-outline border-slate-800 text-slate-400 font-bold px-2 py-0.5">
                  {totalItems} items
                </span>
              </div>
            ...
            {mediaItems.length === 0 ? (
              <div className="p-12 text-center rounded-2xl bg-base-100/10 border border-slate-900 border-dashed text-slate-500">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-grow">
                          <h4
                            className="font-bold text-white text-xs truncate leading-snug"
                            title={name}
                          >
                            {name}
                          </h4>
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            <span className="text-[8px] font-mono bg-base-100 border border-slate-850 px-1 rounded text-slate-400 leading-none py-0.5">
                  ...
                  <div className="flex items-center justify-between border-t border-slate-900 pt-4">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="btn btn-square btn-outline btn-xs border-slate-800 hover:bg-base-100 text-slate-400 hover:text-white"
                      >
